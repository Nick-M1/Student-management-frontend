...
export default function Searchbar({ sortingTextsearch, setSortingTextsearch }: Props) {
    return (
        <div className='border-none cursor-pointer w-full'>
            <div className="group relative flex w-full h-12 rounded-lg bg-white shadow-sm border border-gray-200 hover:border-gray-400 focus-within:ring-1 focus-within:ring-indigo-600 overflow-hidden smooth-transition">
