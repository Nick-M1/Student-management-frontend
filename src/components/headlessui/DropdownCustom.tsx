        ...
        <div className="">
            <Listbox value={selected} onChange={setSelected}>
                <div className="relative mt-1">
                    <Listbox.Button className="relative w-full cursor-pointer text-left input-primary">
                        <span className="block truncate">{ displayOption(selected) }</span>
                            ...
                            {options.map((option) => (
                                ...
                                >
                                    {({ selected }) => (
                                        <>
                                            <span
                                                className={`block truncate smooth-transition ${
